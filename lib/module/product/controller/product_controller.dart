...
class ProductController extends State<ProductView> {
  ...
  List<String> iceLevel = ['30%', '60%', '100%'];
  List<String> sugarLevel = ['30%', '60%', '100%'];
  int selectedIndexSize = 0;
  updateIndexSize(int newIndex) {
    selectedIndexSize = newIndex;
    setState(() {});
  }

  int selectedIndexIce = 0;
  updateIndexIce(int newIndex) {
    selectedIndexIce = newIndex;
    setState(() {});
  }

  int selectedIndexSugar = 0;
  updateIndexSugar(int newIndex) {
    selectedIndexSugar = newIndex;
    setState(() {});
  }
